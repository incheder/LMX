...
import com.wezen.lmx.matches.MatchesFragment.OnListFragmentInteractionListener;
...
public class MatchesRecyclerViewAdapter extends RecyclerView.Adapter<MatchesRecyclerViewAdapter.ViewHolder> {
    ...
    public MatchesRecyclerViewAdapter(List<Match> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
